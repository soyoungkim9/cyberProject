...
var datePickerController = (function datePickerController() {
        ...
        function datePicker(options) {                                      
                ...
                this.updateTable = function(noCallback) {  
                        ...
                        if(o.timerSet) {
                                o.timerInc = 550 + Math.round(((o.timerInc - 50) / 3.8));
                ...
                this.create = function() {
                        ...
                        {colspan:this.showWeeks ? 4 : 3, className:"today-but", id:"-today-but", text:getTitleTranslation(4), onmousedown:function(e) { return true; }, onclick:function(e) { o.date = new Date(); o.updateTable(); }},
                ...
                this.events = {
                        onblur:function(e) {                                    
                                ...
                                /*@cc_on
                                @if(@_win32)
                                o.div.className = o.div.className.replace("datePicker-iefocus", "");                          
                                @end
                                @*/                                  
                        ...
                        onfocus:function(e) {                                 
                                ...
                                /*@cc_on
                                @if(@_win32)                                 
                                o.div.className += " datePicker-iefocus";                                                      
                                @end
                                @*/                                 
                        ...
                        onclick: function(e) {                                                  
                                if(o.opacity != o.opacityTo || this.className.search(/date-picker-unused|out-of-range|day-disabled|no-selection|not-selectable/) != -1) return stopEvent(e);
                                e = e || document.parentWindow.event;
                                var el = e.target != null ? e.target : e.srcElement;
                                while (el.nodeType != 1 || (el.tagName && el.tagName != "TD")) el = el.parentNode;
                                if(el.className.search(/cd-([0-9]{8})/) == -1) { return true; };
                                var cellDate = el.className.match(/cd-([0-9]{8})/)[1];                                                                                                                                                                           
                                o.date = new Date(cellDate.substr(0,4),cellDate.substr(4,2)-1,cellDate.substr(6,2));
                                o.dateSet = new Date(o.date);                                 
                                o.returnFormattedDate();
        ...
        datePicker.prototype.updateStatus = function(msg) {                                
                ...
                if(msg && this.statusFormat.search(/-S|S-/) != -1 && msg.search(/([0-9]{1,2})(st|nd|rd|th)/) != -1) {                
                        ...
                        dc.appendChild(document.createTextNode(msg ? msg : getTitleTranslation(9)));
                        this.statusBar.appendChild(dc);                           
                };                                    
        };
