...
function rssParser(xml) {
	var v = Try.these(
        // Rss ©öoAuA¡í ¡Æ¢®A¢ç ¢¯E¢¥I¢¥U.
        function() {
            return xml.getElementsByTagName("rss")[0].getAttribute("version") ? "2.0" : false;
        },
        function() {
            return xml.getElementsByTagName("rdf:RDF")[0].getAttribute("xmlns") ? "1.0" : false;
        },
        function() {
            return xml.getElementsByTagName("feed")[0].getAttribute("xmlns") ? "atom" : false;
        }
    )
...
Object.extend(rssParser2.prototype, {
    initialize    : function(xml) {
        ...
        this.description = Try.these (
            function() {
                return channel.getElementsByTagName("description")[0].firstChild.nodeValue;
            },
            function() { return "" }
        );
        this.language    = Try.these (
            function() {
                return channel.getElementsByTagName("language")[0].firstChild.nodeValue;
            },
            function() {
                return channel.getElementsByTagName("dc:language")[0].firstChild.nodeValue;
            },
            function() { return ""}
        );
        this.pubDate     = Try.these(
            function() {
                return channel.getElementsByTagName("pubDate")[0].firstChild.nodeValue;
            },
            function() {
                return channel.getElementsByTagName("lastBuildDate")[0].firstChild.nodeValue;
            },
            function() { return ""; }
        );
        var items = new Array();
        $A(channel.getElementsByTagName("item")).each(function(i){
            items.push({
                "category" : Try.these(
                    function() {
                        return i.getElementsByTagName("category")[0].firstChild.nodeValue;
                    },
                    function() { return "" }
                ),
                ...
                "description" : Try.these (
                    function() {
                        return i.getElementsByTagName("description")[0].firstChild.nodeValue;
                    },
                    function() { return "" }
                ),
                "pubDate" : Try.these (
                    function() {
                        return i.getElementsByTagName("pubDate")[0].firstChild.nodeValue;
                    },
                    function() {
                        return i.getElementsByTagName("dc:date")[0].firstChild.nodeValue;
                    },
                    function() { return "" }
                )
            })
