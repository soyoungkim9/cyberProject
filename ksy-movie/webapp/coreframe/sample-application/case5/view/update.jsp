...
<colgroup>
	...
	<td><input id="country" type="text" name="country" value="${output.country}" /></td>
	</tr>
	
	<tr>
	<th><label for="airport" accesskey="c">airport</label> </th>
	<td><input id="airport" type="text" name="airport" value="${output.airport}" /></td>
	</tr>
	
	<tr>
	<th><label for="language" accesskey="c">language</label> </th>
	<td><input id="language" type="text" name="language" value="${output.language}" /></td>
	</tr>	
</table>
